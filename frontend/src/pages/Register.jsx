...
import { User, Store, Mail, Lock, ArrowLeft, Tag, Hash } from 'lucide-react';
...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const errorMsg = error.response?.data?.error || 'Ocurrió un error al registrar el puesto. Inténtalo de nuevo.';
      setAlert({
        type: 'error',
        message: errorMsg
      });
    ...
    <div className="min-h-screen flex flex-col justify-center items-center bg-slate-50 dark:bg-slate-900 px-4 py-8 relative transition-colors duration-200 font-poppins">
      ...
      <div className="w-full max-w-md bg-white dark:bg-slate-800 rounded-2xl shadow-xl p-8 border border-slate-100/50 dark:border-slate-700/30 transition-all duration-200">
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-slate-450 dark:text-slate-500 text-xs mt-1">Registro Digital de Comerciantes</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                >
                  ...
                  <option value="Lácteos y Embutidos">Lácteos y Embutidos</option>
                </select>
          ...
          >
            {loading ? 'Registrando puesto...' : 'Registrar mi Puesto'}
          </button>
        </form>
        ...
        <div className="mt-6 pt-5 border-t border-slate-100 dark:border-slate-700/60 text-center">
          <p className="text-xs text-slate-500 dark:text-slate-455 leading-relaxed">
            ...
            <Link to="/login" className="font-extrabold text-primary hover:underline transition">
              Inicia sesión aquí
            </Link>
          </p>
        </div>
